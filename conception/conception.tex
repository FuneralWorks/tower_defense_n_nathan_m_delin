...
\URCornerWallPaper{.25}{/home/funeralworks/Documents/ENIB/S2/info/tower_defense_n_nathan_m_delin/ressources/ENIB-cartouche-cmjn.jpg}
    ...
    \section{Analyse}
        ...
        \begin{tikzpicture}
                ...
                \node[system] (tty)         [left=of main]{tty.py};
                \node[system] (select)         [below=of tty,yshift=1cm]{select.py};
                \node[system] (termios)         [below=of select,yshift=1cm]{termios.py};
                \node[system] (sys)         [above=of tty,yshift=-1cm]{sys.py};
                ...
                \draw[ar]  (main) to                [bend left=-5] (tty);
                \draw[ar]  (main) to                [bend left=15](select);
                \draw[ar]   (main) to               [bend left=25](termios);
                \draw[ar]   (main) to               [bend left=-25] (sys);
